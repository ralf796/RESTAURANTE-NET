    ...
    function generarReporte(anio, mes) {
        var customStore = new DevExpress.data.CustomStore({
            load: function (loadOptions) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/REPRepartidores/GenerarReporte',
        ...
        var customGraphics = new DevExpress.data.CustomStore({
            load: function (loadOptions) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/REPRepartidores/GenerarGrafica',
                    contentType: "application/json; charset=utf-8",
                    dataType: 'json',
                    data: { anio, mes },
                    cache: false,
        ...
        var PivotGrid = $("#gridContainer").dxDataGrid({
            ...
            onExporting: function (e) {
                ...
                DevExpress.excelExporter.exportDataGrid({
                    ...
                    headerRow.getCell(1).value = 'Reporte de repartidores ' + mesLetras(mes) + ' ' + anio + ', Restaurante Maxima';
                    ...
                    workbook.xlsx.writeBuffer().then(function (buffer) {
                        saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'REPORTE_REPARTIDORES.xlsx');
                    });
                });
                e.cancel = true;
            },
