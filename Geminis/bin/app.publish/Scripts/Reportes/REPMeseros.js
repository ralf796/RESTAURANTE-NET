        ...
        var PivotGrid = $("#gridContainer").dxDataGrid({
            ...
            onExporting: function (e) {
                ...
                DevExpress.excelExporter.exportDataGrid({
                    ...
                    headerRow.getCell(1).value = 'Reporte de meseros de ' + fechaInicial + ' hasta ' + fechaFinal + ', Restaurante Maxima';
                    ...
                    workbook.xlsx.writeBuffer().then(function (buffer) {
                        saveAs(new Blob([buffer], { type: 'application/octet-stream' }), 'REPORTE_MESEROS.xlsx');
                    });
                });
                e.cancel = true;
            },
