        ...
        var PivotGrid = $("#gridContainer").dxDataGrid({
            ...
            onExporting: function (e) {
                ...
                DevExpress.excelExporter.exportDataGrid({
                    ...
                    headerRow.getCell(1).value = 'Reporte de ventas de ' + fechaInicial + ' hasta ' + fechaFinal + ', Restaurante Maxima';
